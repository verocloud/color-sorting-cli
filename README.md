...
For installing the CLI, you can download the `.whl` file from [here](https://github.com/AdrianSimionov/color-sorting-cli/releases/download/0.4.1/harmony-0.4.1-py3-none-any.whl) and run the following command:
